...
module.exports = {
    ...
    excludeFiles: [
        /\.(wp|ios).(scss)$/i,
        /(action-sheet|alert|backdrop|badge|checkbox|chip|datetime|fab|grid|infinite-scroll|input|loading|menu|modal|note|picker|popover|radio|range|refresher|searchbar|select|show-hide-when|slides|split-pane|spinner|toast|toggle|virtual-scroll|cordova)/i,
    ],
